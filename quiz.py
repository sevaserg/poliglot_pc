...
class Window(QWidget):
    ...
    def randomizeWord(self):
        ...
        try:
            ...
            if (random_number > 50 and self.lchoice[2].isChecked() ) or self.lchoice[0].isChecked():
                self.lang = "ru"
                ...
                if (random_number <= 50 and self.lchoice[2].isChecked()) or self.lchoice[1].isChecked():
                    self.lang = "en"
